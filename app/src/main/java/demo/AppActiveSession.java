...
import demo.model.AccountPeriod;
import demo.model.CashFlow;
import demo.model.CashFlowType;

public class AppActiveSession {
    public static void main(String[] args) throws Exception {
        ...
        CashFlow cf2 = new CashFlow(date( "2013-02-02"), 200, CashFlowType.DEBIT, 1 );
        ...
        acp.setEnd(date( "2013-06-30"));
        ksession.update(fh, acp);

        // alternativno, ako treba atomicno da izvrsimo vise akcija nad radnom memorijom
